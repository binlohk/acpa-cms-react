...
const Lesson = ({ match }) => {
  ...
  const lessonListContainerRef = useRef(null)
  ...
  /**To scroll to the current lesson Element **/
  useEffect(() => {
  ...
  useEffect(() => {
    if (
      courseData &&
      lessonListContainerRef.current &&
      focusedLessonRef.current
    ) {
      lessonListContainerRef.current.scrollTop =
       focusedLessonRef.current.offsetTop - lessonListContainerRef.current.offsetTop;
    }
  }, [focusedLessonRef, courseData, lessonListContainerRef])
          ...
          <div className="bg-lesson-bg">
            <div className="pt-6">
              ...
              <div className="flex flex-col lg:flex-none max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16  lg:px-7 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-5">
                ...
                <div
                  className="order-3 lg:order-none  mt-4 lg:mt-0 lg:row-span-3 bg-lessons-card shadow-lg  rounded-lg overflow-y-auto max-h-screen"
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      <p className="text-base text-gray-900">
                        {Parser().parse(
                          DOMPurify.sanitize(lessonData.lessonDescription)
                        )}
                        {VideoToken ? (
                          <>
